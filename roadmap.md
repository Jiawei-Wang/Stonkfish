...
* **Status:** 🚧 MVP complete — interactive layout, mouse-click moves, SAN input, eval meter, and move history. Keyboard navigation and drag-and-drop are still pending.
